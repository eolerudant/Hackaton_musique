...
if __name__ == "__main__":
    ...
    nom_fichier_partition = "runaway.txt"  
    ...
    try:
        ...
        #Interprétation en données Python
        ...
        print(f"Vérifie que tu as bien créé un fichier nommé {nom_fichier_partition} dans le dossier")
